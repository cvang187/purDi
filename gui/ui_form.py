...
class Ui_BasePurDi(object):
    def setupUi(self, BasePurDi):
        if not BasePurDi.objectName():
            BasePurDi.setObjectName(u"BasePurDi")
        ...
        BasePurDi.setStyleSheet(u"")
        BasePurDi.setIconSize(QSize(48, 48))
        BasePurDi.setTabShape(QTabWidget.Rounded)
        BasePurDi.setDockNestingEnabled(True)
        BasePurDi.setDockOptions(QMainWindow.AllowNestedDocks|QMainWindow.AllowTabbedDocks|QMainWindow.AnimatedDocks|QMainWindow.ForceTabbedDocks|QMainWindow.GroupedDragging|QMainWindow.VerticalTabs)
        ...
        self.right_top_dock_widget.setObjectName(u"right_top_dock_widget")
        sizePolicy.setHeightForWidth(self.right_top_dock_widget.sizePolicy().hasHeightForWidth())
        ...
        self.right_top_dock_widget.setFeatures(QDockWidget.DockWidgetClosable|QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
        self.right_top_dock_widget.setAllowedAreas(Qt.LeftDockWidgetArea|Qt.RightDockWidgetArea)
        self.right_dock_main = QWidget()
        self.right_dock_main.setObjectName(u"right_dock_main")
        sizePolicy1 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.right_dock_main.sizePolicy().hasHeightForWidth())
        ...
        self.right_dock_layout.setObjectName(u"right_dock_layout")
        ...
        self.right_dock_tab_widget.setObjectName(u"right_dock_tab_widget")
        self.right_dock_tab_widget.setEnabled(True)
        sizePolicy.setHeightForWidth(self.right_dock_tab_widget.sizePolicy().hasHeightForWidth())
        ...
        self.right_dock_inference.setObjectName(u"right_dock_inference")
        sizePolicy1.setHeightForWidth(self.right_dock_inference.sizePolicy().hasHeightForWidth())
        ...
        self.right_dock_inference_tab.setObjectName(u"right_dock_inference_tab")
        sizePolicy.setHeightForWidth(self.right_dock_inference_tab.sizePolicy().hasHeightForWidth())
        ...
        self.right_dock_inference_tab.setStyleSheet(u"")
        ...
        self.right_dock_inference_txt2img.setObjectName(u"right_dock_inference_txt2img")
        ...
        self.inference_general_setting.setObjectName(u"inference_general_setting")
        sizePolicy2 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.inference_general_setting.sizePolicy().hasHeightForWidth())
        self.inference_general_setting.setSizePolicy(sizePolicy2)
        self.inference_general_setting.setMaximumSize(QSize(350, 16777215))
        self.inference_general_setting.setStyleSheet(u"border-color: rgba(0, 0, 0, 0);")
        ...
        self.width_layout.setObjectName(u"width_layout")
        ...
        self.width_slider_bar.setObjectName(u"width_slider_bar")
        ...
        self.width_field.setObjectName(u"width_field")
        ...
        self.height_slider_bar.setObjectName(u"height_slider_bar")
        ...
        self.height_field.setObjectName(u"height_field")
        sizePolicy2.setHeightForWidth(self.height_field.sizePolicy().hasHeightForWidth())
        ...
        self.select_seed.setObjectName(u"select_seed")
        ...
        self.schedulers_label.setObjectName(u"schedulers_label")
        ...
        self.scheduler_drop_down_box.setObjectName(u"scheduler_drop_down_box")
        sizePolicy3 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.scheduler_drop_down_box.sizePolicy().hasHeightForWidth())
        ...
        self.cfg_slider_bar.setObjectName(u"cfg_slider_bar")
        self.cfg_slider_bar.setInputMethodHints(Qt.ImhDigitsOnly|Qt.ImhNoPredictiveText)
        ...
        self.cfg_field.setObjectName(u"cfg_field")
        ...
        self.steps_slider_bar.setObjectName(u"steps_slider_bar")
        ...
        self.img_options_setting.setObjectName(u"img_options_setting")
        sizePolicy1.setHeightForWidth(self.img_options_setting.sizePolicy().hasHeightForWidth())
        ...
        self.img_options_setting.setStyleSheet(u"border-color: rgba(191, 64, 64, 0);")
        ...
        self.txt2img_checkbox.setObjectName(u"txt2img_checkbox")
        ...
        self.attend_excite_pixmap.setObjectName(u"attend_excite_pixmap")
        ...
        self.max_iter_to_alter_field.setObjectName(u"max_iter_to_alter_field")
        ...
        self.attend_excite_checkbox.setObjectName(u"attend_excite_checkbox")
        ...
        self.multi_diffusion_pixmap.setObjectName(u"multi_diffusion_pixmap")
        ...
        self.multidiffusion_panorama_checkbox.setObjectName(u"multidiffusion_panorama_checkbox")
        ...
        self.self_attention_guidance.setObjectName(u"self_attention_guidance")
        ...
        self.sag_scale_field.setObjectName(u"sag_scale_field")
        ...
        self.self_attention_guidance_checkbox.setObjectName(u"self_attention_guidance_checkbox")
        ...
        self.toolBox.addItem(self.page_4, u"Self-Attention Guidance")
        ...
        self.right_dock_inference_img2img.setObjectName(u"right_dock_inference_img2img")
        self.right_dock_inference_img2img.setStyleSheet(u"border-color: rgba(191, 64, 64, 0);")
        ...
        self.img2img_container.setObjectName(u"img2img_container")
        sizePolicy5 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Minimum)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.img2img_container.sizePolicy().hasHeightForWidth())
        ...
        self.img2img_select_box.setObjectName(u"img2img_select_box")
        sizePolicy6 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Minimum)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.img2img_select_box.sizePolicy().hasHeightForWidth())
        ...
        self.img2img_clear_btn.setObjectName(u"img2img_clear_btn")
        sizePolicy7 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy7.setHorizontalStretch(0)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.img2img_clear_btn.sizePolicy().hasHeightForWidth())
        ...
        self.img2img_options.setObjectName(u"img2img_options")
        sizePolicy8 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        sizePolicy8.setHorizontalStretch(0)
        sizePolicy8.setVerticalStretch(0)
        sizePolicy8.setHeightForWidth(self.img2img_options.sizePolicy().hasHeightForWidth())
        ...
        self.image_variation_toolbox.setObjectName(u"image_variation_toolbox")
        sizePolicy.setHeightForWidth(self.image_variation_toolbox.sizePolicy().hasHeightForWidth())
        ...
        self.img2img_deviation_percent.setObjectName(u"img2img_deviation_percent")
        self.img2img_deviation_percent.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.img_deviation_layout.setObjectName(u"img_deviation_layout")
        self.img_deviation_layout.setContentsMargins(-1, 0, -1, -1)
        self.img2img_strength_slider_bar = QSlider(self.page)
        self.img2img_strength_slider_bar.setObjectName(u"img2img_strength_slider_bar")
        sizePolicy9 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy9.setHorizontalStretch(0)
        sizePolicy9.setVerticalStretch(0)
        sizePolicy9.setHeightForWidth(self.img2img_strength_slider_bar.sizePolicy().hasHeightForWidth())
        ...
        self.img2img_strength_field.setObjectName(u"img2img_strength_field")
        ...
        self.img2img_checkbox.setObjectName(u"img2img_checkbox")
        self.img2img_checkbox.setChecked(True)

        self.verticalLayout_19.addWidget(self.img2img_checkbox)

        self.image_variation_toolbox.addItem(self.page, u"Image-to-Image")
        ...
        self.controlnet_pixmap.setObjectName(u"controlnet_pixmap")
        ...
        self.controlnet_method_combobox.addItem("")
        self.controlnet_method_combobox.addItem("")
        self.controlnet_method_combobox.setObjectName(u"controlnet_method_combobox")
        sizePolicy10 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy10.setHorizontalStretch(0)
        sizePolicy10.setVerticalStretch(0)
        sizePolicy10.setHeightForWidth(self.controlnet_method_combobox.sizePolicy().hasHeightForWidth())
        ...
        self.canny_low_threshold.setObjectName(u"canny_low_threshold")

        self.horizontalLayout_6.addWidget(self.canny_low_threshold)

        self.canny_high_threshold = QLineEdit(self.ControlNet)
        self.canny_high_threshold.setObjectName(u"canny_high_threshold")
        ...
        self.canny_conditioning_scale.setObjectName(u"canny_conditioning_scale")
        ...
        self.controlnet_checkbox.setObjectName(u"controlnet_checkbox")
        ...
        self.save_controlnet_input_maps_checkbox.setObjectName(u"save_controlnet_input_maps_checkbox")
        ...
        self.image_variation_toolbox.addItem(self.ControlNet, u"ControlNet")
        self.cycle_diffusion_widget = QWidget()
        self.cycle_diffusion_widget.setObjectName(u"cycle_diffusion_widget")
        ...
        self.cycle_diffusion_pixmap.setObjectName(u"cycle_diffusion_pixmap")
        sizePolicy.setHeightForWidth(self.cycle_diffusion_pixmap.sizePolicy().hasHeightForWidth())
        ...
        self.cycle_diffusion_label.setObjectName(u"cycle_diffusion_label")
        sizePolicy4.setHeightForWidth(self.cycle_diffusion_label.sizePolicy().hasHeightForWidth())
        self.cycle_diffusion_label.setSizePolicy(sizePolicy4)
        self.cycle_diffusion_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.cycle_diffusion_checkbox.setObjectName(u"cycle_diffusion_checkbox")
        self.cycle_diffusion_checkbox.setAutoExclusive(False)

        self.verticalLayout_30.addWidget(self.cycle_diffusion_checkbox)

        self.image_variation_toolbox.addItem(self.cycle_diffusion_widget, u"Cycle Diffusion")
        self.depth_to_image_widget = QWidget()
        self.depth_to_image_widget.setObjectName(u"depth_to_image_widget")
        ...
        self.depth_to_image_checkbox.setObjectName(u"depth_to_image_checkbox")

        self.verticalLayout_31.addWidget(self.depth_to_image_checkbox)

        self.image_variation_toolbox.addItem(self.depth_to_image_widget, u"Depth-to-Image")
        self.image_variation_widget = QWidget()
        self.image_variation_widget.setObjectName(u"image_variation_widget")
        ...
        self.image_variations_pixmap.setObjectName(u"image_variations_pixmap")
        ...
        self.img2img_image_variation_label.setObjectName(u"img2img_image_variation_label")
        sizePolicy4.setHeightForWidth(self.img2img_image_variation_label.sizePolicy().hasHeightForWidth())
        self.img2img_image_variation_label.setSizePolicy(sizePolicy4)
        self.img2img_image_variation_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.img2img_image_variation_checkbox.setObjectName(u"img2img_image_variation_checkbox")
        ...
        self.image_variation_toolbox.addItem(self.image_variation_widget, u"Image Variation")
        self.page_7 = QWidget()
        ...
        self.inpaint_pixmap.setObjectName(u"inpaint_pixmap")
        ...
        self.inpaint_checkbox.setObjectName(u"inpaint_checkbox")
        ...
        self.instruct_pix2pix_pixmap.setObjectName(u"instruct_pix2pix_pixmap")
        ...
        self.img_guidance_scale_label.setObjectName(u"img_guidance_scale_label")
        ...
        self.img_guidance_slider_bar.setObjectName(u"img_guidance_slider_bar")
        ...
        self.img_guidance_scale_field.setObjectName(u"img_guidance_scale_field")
        sizePolicy2.setHeightForWidth(self.img_guidance_scale_field.sizePolicy().hasHeightForWidth())
        ...
        self.instruct_pix2pix_checkbox.setObjectName(u"instruct_pix2pix_checkbox")

        self.verticalLayout_18.addWidget(self.instruct_pix2pix_checkbox)

        self.image_variation_toolbox.addItem(self.instruct_pix2pix_widget, u"InstructPix2Pix")
        self.page_6 = QWidget()
        ...
        self.zero_pix2pix_pixmap.setObjectName(u"zero_pix2pix_pixmap")
        ...
        self.pix2pix_source_field.setObjectName(u"pix2pix_source_field")

        self.horizontalLayout_2.addWidget(self.pix2pix_source_field)

        self.pix2pix_target_field = QLineEdit(self.page_6)
        self.pix2pix_target_field.setObjectName(u"pix2pix_target_field")
        ...
        self.pix2pix_zero_checkbox.setObjectName(u"pix2pix_zero_checkbox")

        self.verticalLayout_37.addWidget(self.pix2pix_zero_checkbox)

        self.image_variation_toolbox.addItem(self.page_6, u"Pix2Pix Zero-shot")
        ...
        self.right_dock_inference_general.setObjectName(u"right_dock_inference_general")
        ...
        self.optimization_options.setObjectName(u"optimization_options")
        ...
        self.optimization_toolbox.setObjectName(u"optimization_toolbox")
        self.attention_slicing_item = QWidget()
        self.attention_slicing_item.setObjectName(u"attention_slicing_item")
        ...
        self.attention_slicing_checkbox.setObjectName(u"attention_slicing_checkbox")
        ...
        self.model_cpu_offload_checkbox.setObjectName(u"model_cpu_offload_checkbox")
        ...
        self.sequential_cpu_offload_checkbox.setObjectName(u"sequential_cpu_offload_checkbox")
        ...
        self.cpu_offload_disable.setObjectName(u"cpu_offload_disable")
        ...
        self.optimization_toolbox.addItem(self.cpu_offload_item, u"CPU Offload")
        self.cudnn_item = QWidget()
        self.cudnn_item.setObjectName(u"cudnn_item")
        ...
        self.cudnn_checkbox.setObjectName(u"cudnn_checkbox")
        self.cudnn_checkbox.setChecked(True)

        self.verticalLayout_21.addWidget(self.cudnn_checkbox)

        self.optimization_toolbox.addItem(self.cudnn_item, u"cuDNN Auto-Tuner")
        self.half_precision_item = QWidget()
        self.half_precision_item.setObjectName(u"half_precision_item")
        ...
        self.half_precision_checkbox.setObjectName(u"half_precision_checkbox")
        self.half_precision_checkbox.setChecked(True)

        self.verticalLayout_26.addWidget(self.half_precision_checkbox)

        self.optimization_toolbox.addItem(self.half_precision_item, u"Half Precision")
        self.memory_efficient_item = QWidget()
        self.memory_efficient_item.setObjectName(u"memory_efficient_item")
        ...
        self.memory_efficient_attention_checkbox.setObjectName(u"memory_efficient_attention_checkbox")
        ...
        self.optimization_toolbox.addItem(self.memory_efficient_item, u"Memory Efficient Attention - Xformer")
        self.tf32_item = QWidget()
        self.tf32_item.setObjectName(u"tf32_item")
        ...
        self.tf32_item_checkbox.setObjectName(u"tf32_item_checkbox")
        ...
        self.sliced_vae_decode_checkbox.setObjectName(u"sliced_vae_decode_checkbox")
        self.sliced_vae_decode_checkbox.setChecked(False)

        self.verticalLayout_27.addWidget(self.sliced_vae_decode_checkbox)

        self.optimization_toolbox.addItem(self.sliced_vae_item, u"Sliced VAE")
        ...
        self.image_upscaling_group.setObjectName(u"image_upscaling_group")
        self.image_upscaling_group.setStyleSheet(u"border-color: rgba(255, 255, 255, 0);")
        ...
        self.vqfr_pixmap.setObjectName(u"vqfr_pixmap")
        ...
        self.vqfr_checkbox.setObjectName(u"vqfr_checkbox")
        ...
        self.toolBox_2.addItem(self.page_9, u"CodeFormer")

        self.verticalLayout_39.addWidget(self.toolBox_2)

        self.inference_general_options = QGroupBox(self.image_upscaling_group)
        self.inference_general_options.setObjectName(u"inference_general_options")
        self.inference_general_options.setStyleSheet(u"border-color: rgba(255, 255, 255, 0);")
        ...
        self.latent_upscale_2x.setObjectName(u"latent_upscale_2x")
        ...
        self.right_dock_train.setObjectName(u"right_dock_train")
        self.right_dock_train.setEnabled(False)
        sizePolicy.setHeightForWidth(self.right_dock_train.sizePolicy().hasHeightForWidth())
        ...
        self.sb_tab_sub_r_train.setObjectName(u"sb_tab_sub_r_train")
        ...
        self.train_dreambooth.setObjectName(u"train_dreambooth")
        sizePolicy.setHeightForWidth(self.train_dreambooth.sizePolicy().hasHeightForWidth())
        ...
        self.train_textual_inversion.setObjectName(u"train_textual_inversion")
        sizePolicy.setHeightForWidth(self.train_textual_inversion.sizePolicy().hasHeightForWidth())
        ...
        self.train_lora.setObjectName(u"train_lora")
        ...
        self.chat_mode.setObjectName(u"chat_mode")
        self.right_dock_tab_widget.addTab(self.chat_mode, "")
        self.right_dock_general = QWidget()
        self.right_dock_general.setObjectName(u"right_dock_general")
        sizePolicy1.setHeightForWidth(self.right_dock_general.sizePolicy().hasHeightForWidth())
        self.right_dock_general.setSizePolicy(sizePolicy1)
        self.right_dock_general.setMaximumSize(QSize(16777215, 8192))
        self.right_dock_general.setStyleSheet(u"border-color: rgba(0, 0, 0, 0);")
        ...
        self.sb_r_general_v_layout.setObjectName(u"sb_r_general_v_layout")
        self.sb_r_general_v_layout.setContentsMargins(-1, -1, -1, 0)
        self.gb_general_layer = QGroupBox(self.right_dock_general)
        self.gb_general_layer.setObjectName(u"gb_general_layer")
        ...
        self.layers_list.setObjectName(u"layers_list")
        self.layers_list.setSizeAdjustPolicy(QAbstractScrollArea.AdjustIgnored)
        self.layers_list.setEditTriggers(QAbstractItemView.DoubleClicked|QAbstractItemView.EditKeyPressed|QAbstractItemView.SelectedClicked)
        ...
        self.edit_theme_button.setObjectName(u"edit_theme_button")
        ...
        self.generate_img_progress.setObjectName(u"generate_img_progress")
        sizePolicy10.setHeightForWidth(self.generate_img_progress.sizePolicy().hasHeightForWidth())
        ...
        self.prompt_field.setObjectName(u"prompt_field")
        ...
        self.prompt_field.setStyleSheet(u"color: rgb(36, 31, 49);")
        ...
        self.prompt_positive_tab.setObjectName(u"prompt_positive_tab")
        sizePolicy.setHeightForWidth(self.prompt_positive_tab.sizePolicy().hasHeightForWidth())
        ...
        self.prompt_positive_field.setObjectName(u"prompt_positive_field")
        sizePolicy.setHeightForWidth(self.prompt_positive_field.sizePolicy().hasHeightForWidth())
        ...
        self.prompt_positive_field.setStyleSheet(u"color: rgb(36, 31, 49);")
        ...
        self.prompt_negative_tab.setObjectName(u"prompt_negative_tab")
        sizePolicy.setHeightForWidth(self.prompt_negative_tab.sizePolicy().hasHeightForWidth())
        ...
        self.prompt_negative_field.setObjectName(u"prompt_negative_field")
        sizePolicy.setHeightForWidth(self.prompt_negative_field.sizePolicy().hasHeightForWidth())
        self.prompt_negative_field.setSizePolicy(sizePolicy)
        self.prompt_negative_field.setMaximumSize(QSize(380, 300))
        self.prompt_negative_field.setStyleSheet(u"color: rgb(36, 31, 49);")
        ...
        sizePolicy10.setHeightForWidth(self.generate_button.sizePolicy().hasHeightForWidth())
        ...
        self.status_bar.setStyleSheet(u"background-color: rgb(37, 41, 43);")
        self.status_bar.setSizeGripEnabled(False)
        BasePurDi.setStatusBar(self.status_bar)
        self.left_dock_widget = QDockWidget(BasePurDi)
        self.left_dock_widget.setObjectName(u"left_dock_widget")
        sizePolicy11 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Expanding)
        sizePolicy11.setHorizontalStretch(0)
        sizePolicy11.setVerticalStretch(0)
        sizePolicy11.setHeightForWidth(self.left_dock_widget.sizePolicy().hasHeightForWidth())
        ...
        self.left_dock_widget.setFeatures(QDockWidget.DockWidgetClosable|QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
        ...
        self.left_frame.setStyleSheet(u"border-color: rgba(191, 64, 64, 0);")
        ...
        self.left_tab_widget.setObjectName(u"left_tab_widget")
        self.left_tab_widget.setEnabled(True)
        sizePolicy.setHeightForWidth(self.left_tab_widget.sizePolicy().hasHeightForWidth())
        ...
        self.left_tab_widget.setStyleSheet(u"")
        ...
        self.image_browser_widget.setObjectName(u"image_browser_widget")
        sizePolicy.setHeightForWidth(self.image_browser_widget.sizePolicy().hasHeightForWidth())
        ...
        self.image_browser_widget.setStyleSheet(u"")
        self.img_browser_search_layout = QVBoxLayout(self.image_browser_widget)
        self.img_browser_search_layout.setSpacing(0)
        self.img_browser_search_layout.setObjectName(u"img_browser_search_layout")
        ...
        self.image_browser_layout.setObjectName(u"image_browser_layout")
        ...
        self.image_browser_search.setObjectName(u"image_browser_search")
        ...
        self.image_browser_sort.addItem("")
        self.image_browser_sort.addItem("")
        self.image_browser_sort.setObjectName(u"image_browser_sort")
        sizePolicy12 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy12.setHorizontalStretch(0)
        sizePolicy12.setVerticalStretch(0)
        sizePolicy12.setHeightForWidth(self.image_browser_sort.sizePolicy().hasHeightForWidth())
        ...
        self.image_browser.setObjectName(u"image_browser")
        ...
        self.image_browser.setStyleSheet(u"")
        self.image_browser.setEditTriggers(QAbstractItemView.DoubleClicked|QAbstractItemView.EditKeyPressed)
        ...
        self.bottom_dock_prompts.setObjectName(u"bottom_dock_prompts")
        sizePolicy.setHeightForWidth(self.bottom_dock_prompts.sizePolicy().hasHeightForWidth())
        self.bottom_dock_prompts.setSizePolicy(sizePolicy)
        self.bottom_dock_prompts.setMaximumSize(QSize(8192, 8192))
        self.bottom_dock_prompts.setStyleSheet(u"")
        ...
        self.bottom_dock_prompts_layout.setObjectName(u"bottom_dock_prompts_layout")
        ...
        self.bottom_prompts_search_bar_btn.setObjectName(u"bottom_prompts_search_bar_btn")
        ...
        self.bottom_prompts_sort.addItem("")
        self.bottom_prompts_sort.setObjectName(u"bottom_prompts_sort")
        ...
        self.bottom_dock_prompts_table.setObjectName(u"bottom_dock_prompts_table")
        self.bottom_dock_prompts_table.setMinimumSize(QSize(0, 0))
        self.bottom_dock_prompts_table.setStyleSheet(u"")
        self.bottom_dock_prompts_table.setAutoScroll(True)
        self.bottom_dock_prompts_table.setEditTriggers(QAbstractItemView.AnyKeyPressed|QAbstractItemView.DoubleClicked|QAbstractItemView.EditKeyPressed)
        ...
        self.bottom_dock_prompts_table.horizontalHeader().setCascadingSectionResizes(False)
        ...
        self.bottom_dock_prompts_table.horizontalHeader().setProperty("showSortIndicator", True)
        ...
        self.bottom_dock_prompts_table.verticalHeader().setProperty("showSortIndicator", True)
        ...
        self.history_widget.setObjectName(u"history_widget")
        ...
        self.history_widget.setStyleSheet(u"")
        ...
        self.history_layout_horizontal.setObjectName(u"history_layout_horizontal")
        self.history_layout_horizontal.setContentsMargins(0, 0, -1, -1)
        self.history_search_bar_btn = QLineEdit(self.history_widget)
        self.history_search_bar_btn.setObjectName(u"history_search_bar_btn")
        ...
        self.history_sort.addItem("")
        self.history_sort.addItem("")
        self.history_sort.setObjectName(u"history_sort")
        sizePolicy7.setHeightForWidth(self.history_sort.sizePolicy().hasHeightForWidth())
        ...
        self.img_history_table.setObjectName(u"img_history_table")
        self.img_history_table.setMaximumSize(QSize(8192, 8192))
        self.img_history_table.setStyleSheet(u"")
    ...
    def retranslateUi(self, BasePurDi):
        BasePurDi.setWindowTitle(QCoreApplication.translate("BasePurDi", u"PurDi - AI Enhanced Image Generator & Editor", None))
#if QT_CONFIG(tooltip)
        BasePurDi.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.actionOpen.setText(QCoreApplication.translate("BasePurDi", u"Open", None))
#if QT_CONFIG(shortcut)
        self.actionOpen.setShortcut(QCoreApplication.translate("BasePurDi", u"Ctrl+O", None))
#endif // QT_CONFIG(shortcut)
        self.actionSave.setText(QCoreApplication.translate("BasePurDi", u"Save", None))
#if QT_CONFIG(shortcut)
        self.actionSave.setShortcut(QCoreApplication.translate("BasePurDi", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.actionSettings.setText(QCoreApplication.translate("BasePurDi", u"Settings", None))
#if QT_CONFIG(shortcut)
        self.actionSettings.setShortcut(QCoreApplication.translate("BasePurDi", u"Ctrl+Alt+Shift+S", None))
#endif // QT_CONFIG(shortcut)
        self.actionUndo.setText(QCoreApplication.translate("BasePurDi", u"Undo", None))
#if QT_CONFIG(shortcut)
        self.actionUndo.setShortcut(QCoreApplication.translate("BasePurDi", u"Ctrl+Z", None))
#endif // QT_CONFIG(shortcut)
        self.actionRedo.setText(QCoreApplication.translate("BasePurDi", u"Redo", None))
#if QT_CONFIG(shortcut)
        self.actionRedo.setShortcut(QCoreApplication.translate("BasePurDi", u"Ctrl+Shift+Z", None))
#endif // QT_CONFIG(shortcut)
        self.actionFilters.setText(QCoreApplication.translate("BasePurDi", u"Filters", None))
        self.right_top_dock_widget.setWindowTitle(QCoreApplication.translate("BasePurDi", u"Dock", None))
#if QT_CONFIG(tooltip)
        ...
        self.inference_general_setting.setTitle(QCoreApplication.translate("BasePurDi", u"General", None))
        self.width_label.setText(QCoreApplication.translate("BasePurDi", u"W:", None))
        self.width_field.setInputMask("")
        self.width_field.setText(QCoreApplication.translate("BasePurDi", u"512", None))
        self.width_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"768", None))
        self.height_label.setText(QCoreApplication.translate("BasePurDi", u"H:", None))
        self.height_field.setText(QCoreApplication.translate("BasePurDi", u"512", None))
        self.height_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"768", None))
        self.select_n_sample.setText("")
        self.select_n_sample.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"imgs to generate", None))
        self.select_batch_size.setText("")
        self.select_batch_size.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"batch size", None))
#if QT_CONFIG(tooltip)
        self.select_seed.setToolTip(QCoreApplication.translate("BasePurDi", u"Leave blank to always use random seed for each image", None))
#endif // QT_CONFIG(tooltip)
        self.select_seed.setText("")
        self.select_seed.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"seed", None))
        self.random_seed.setText(QCoreApplication.translate("BasePurDi", u"Random", None))
        self.schedulers_label.setText(QCoreApplication.translate("BasePurDi", u"Schedulers:", None))
        self.cfg_label.setText(QCoreApplication.translate("BasePurDi", u"CFG: ", None))
        self.cfg_field.setText(QCoreApplication.translate("BasePurDi", u"6", None))
        self.cfg_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"7.0", None))
        self.steps_label.setText(QCoreApplication.translate("BasePurDi", u"Steps: ", None))
        self.steps_field.setText(QCoreApplication.translate("BasePurDi", u"20", None))
        self.steps_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"30", None))
        self.img_options_setting.setTitle(QCoreApplication.translate("BasePurDi", u"Options", None))
        self.label_15.setText(QCoreApplication.translate("BasePurDi", u"Normal Text-to-Image with no options.", None))
        self.txt2img_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_5), QCoreApplication.translate("BasePurDi", u"Text-to-Image", None))
        self.attend_excite_pixmap.setText("")
        self.label_10.setText(QCoreApplication.translate("BasePurDi", u"Guides the generative model to modify the cross-attention values during image generation to attend to all subjects in the text.", None))
        self.label_18.setText(QCoreApplication.translate("BasePurDi", u"Max number of iterations to alter", None))
        self.max_iter_to_alter_field.setText(QCoreApplication.translate("BasePurDi", u"20", None))
        self.attend_excite_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), QCoreApplication.translate("BasePurDi", u"Attend And Excite", None))
        self.multi_diffusion_pixmap.setText("")
        self.label_11.setText(QCoreApplication.translate("BasePurDi", u"MultiDiffusion, a unified framework that enables versatile and controllable image generation, using a pre-trained text-to-image diffusion model, without any further training or finetuning.", None))
        self.multidiffusion_panorama_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), QCoreApplication.translate("BasePurDi", u"MultiDiffusion", None))
        self.self_attention_guidance.setText("")
        self.label_12.setText(QCoreApplication.translate("BasePurDi", u"Guides diffusion models to generate images with higher quality and coherence.", None))
        self.label_8.setText(QCoreApplication.translate("BasePurDi", u"Self-Attention Guidance Scale (0 - 1):", None))
        self.sag_scale_field.setText(QCoreApplication.translate("BasePurDi", u".75", None))
#if QT_CONFIG(tooltip)
        self.self_attention_guidance_checkbox.setToolTip(QCoreApplication.translate("BasePurDi", u"Self-Attention Guidance", None))
#endif // QT_CONFIG(tooltip)
        self.self_attention_guidance_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), QCoreApplication.translate("BasePurDi", u"Self-Attention Guidance", None))
        self.right_dock_inference_tab.setTabText(self.right_dock_inference_tab.indexOf(self.right_dock_inference_txt2img), QCoreApplication.translate("BasePurDi", u"text", None))
#if QT_CONFIG(tooltip)
        self.right_dock_inference_tab.setTabToolTip(self.right_dock_inference_tab.indexOf(self.right_dock_inference_txt2img), QCoreApplication.translate("BasePurDi", u"Text to Text Image Generation", None))
#endif // QT_CONFIG(tooltip)
        self.img2img_container.setTitle(QCoreApplication.translate("BasePurDi", u"Image to Image", None))
        self.img2img_clear_btn.setText(QCoreApplication.translate("BasePurDi", u"Clear", None))
        self.img2img_options.setTitle(QCoreApplication.translate("BasePurDi", u"Options", None))
        self.img2img_deviation_percent.setText(QCoreApplication.translate("BasePurDi", u"Original Image Deviation (%)", None))
        self.img2img_strength_field.setInputMask("")
        self.img2img_strength_field.setText(QCoreApplication.translate("BasePurDi", u"75", None))
        self.img2img_strength_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"75%", None))
        self.img2img_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.page), QCoreApplication.translate("BasePurDi", u"Image-to-Image", None))
        self.controlnet_pixmap.setText("")
        self.label_19.setText(QCoreApplication.translate("BasePurDi", u"Enables conditional inputs like edge maps, segmentation maps, keypoints, etc for finer control of output image structure", None))
        self.controlnet_method_combobox.setItemText(0, QCoreApplication.translate("BasePurDi", u"Canny Edge Detection", None))
        self.controlnet_method_combobox.setItemText(1, QCoreApplication.translate("BasePurDi", u"Depth Map Detection", None))
        self.controlnet_method_combobox.setItemText(2, QCoreApplication.translate("BasePurDi", u"HED Edge Detection", None))
        self.controlnet_method_combobox.setItemText(3, QCoreApplication.translate("BasePurDi", u"M-LSD Line Detection", None))
        self.controlnet_method_combobox.setItemText(4, QCoreApplication.translate("BasePurDi", u"OpenPose Bone Detection", None))
        self.controlnet_method_combobox.setItemText(5, QCoreApplication.translate("BasePurDi", u"Scribble", None))
        self.controlnet_method_combobox.setItemText(6, QCoreApplication.translate("BasePurDi", u"Semantic Segmentation", None))

#if QT_CONFIG(statustip)
        self.canny_low_threshold.setStatusTip(QCoreApplication.translate("BasePurDi", u"Default is 100", None))
#endif // QT_CONFIG(statustip)
        self.canny_low_threshold.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Low Threshold", None))
#if QT_CONFIG(statustip)
        self.canny_high_threshold.setStatusTip(QCoreApplication.translate("BasePurDi", u"Default is 200", None))
#endif // QT_CONFIG(statustip)
        self.canny_high_threshold.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"High Threshold", None))
        self.canny_conditioning_scale.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Conditioning Scale", None))
        self.controlnet_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.save_controlnet_input_maps_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Save Map", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.ControlNet), QCoreApplication.translate("BasePurDi", u"ControlNet", None))
        self.cycle_diffusion_pixmap.setText("")
        self.cycle_diffusion_label.setText(QCoreApplication.translate("BasePurDi", u"A Text-Guided Image-to-Image Generation model proposed in Unifying Diffusion Models\u2019 Latent Space, with Applications to CycleDiffusion and Guidance by Chen Henry Wu, Fernando De la Torre. WARNING: Only 1.4 checkpoints", None))
        self.cycle_diffusion_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.cycle_diffusion_widget), QCoreApplication.translate("BasePurDi", u"Cycle Diffusion", None))
        self.label_9.setText(QCoreApplication.translate("BasePurDi", u"A depth-guided diffusion model by CompVis, Stability AI, and LAION. It uses MiDas to infer depth based on an image.", None))
        self.depth_to_image_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.depth_to_image_widget), QCoreApplication.translate("BasePurDi", u"Depth-to-Image", None))
        self.image_variations_pixmap.setText("")
        self.img2img_image_variation_label.setText(QCoreApplication.translate("BasePurDi", u"Generate variations from an input image using a fine-tuned version of Stable Diffusion model by Justin Pinkney. Does not take text prompt into consideration.", None))
        self.img2img_image_variation_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.image_variation_widget), QCoreApplication.translate("BasePurDi", u"Image Variation", None))
        self.inpaint_pixmap.setText("")
        self.inpaint_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.page_7), QCoreApplication.translate("BasePurDi", u"In-painting", None))
        self.instruct_pix2pix_pixmap.setText("")
        self.label_13.setText(QCoreApplication.translate("BasePurDi", u"A method for editing images from human instructions: given an input image and a written instruction that tells the model what to do, our model follows these instructions to edit the image.", None))
        self.img_guidance_scale_label.setText(QCoreApplication.translate("BasePurDi", u"Image Guidance Scale", None))
        self.img_guidance_scale_field.setText(QCoreApplication.translate("BasePurDi", u"2", None))
        self.instruct_pix2pix_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.instruct_pix2pix_widget), QCoreApplication.translate("BasePurDi", u"InstructPix2Pix", None))
        self.zero_pix2pix_pixmap.setText("")
        self.label_16.setText(QCoreApplication.translate("BasePurDi", u"A diffusion-based image-to-image approach that allows users to specify the edit direction on-the-fly and allows editing real and synthetic images while preserving the input image's structure", None))
        self.pix2pix_source_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Source Subject", None))
        self.pix2pix_target_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Target Subject", None))
        self.pix2pix_zero_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.image_variation_toolbox.setItemText(self.image_variation_toolbox.indexOf(self.page_6), QCoreApplication.translate("BasePurDi", u"Pix2Pix Zero-shot", None))
        self.right_dock_inference_tab.setTabText(self.right_dock_inference_tab.indexOf(self.right_dock_inference_img2img), QCoreApplication.translate("BasePurDi", u"img", None))
#if QT_CONFIG(tooltip)
        self.right_dock_inference_tab.setTabToolTip(self.right_dock_inference_tab.indexOf(self.right_dock_inference_img2img), QCoreApplication.translate("BasePurDi", u"Image to Image Generation", None))
#endif // QT_CONFIG(tooltip)
        self.optimization_options.setTitle(QCoreApplication.translate("BasePurDi", u"Optimizations", None))
        self.label.setText(QCoreApplication.translate("BasePurDi", u"For even additional memory savings, you can use a sliced version of attention that performs the computation in steps instead of all at once. Attention slicing is useful even if a batch size of just 1 is used - as long as the model uses more than one attention head. If there is more than one attention head the *QK^T* attention matrix can be computed sequentially for each head which can save a significant amount of memory.", None))
        self.attention_slicing_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Attention Slicing", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.attention_slicing_item), QCoreApplication.translate("BasePurDi", u"Attention Slicing", None))
        self.label_2.setText(QCoreApplication.translate("BasePurDi", u"For additional memory savings, you can offload the weights to CPU and only load them to GPU when performing the forward pass.", None))
        self.model_cpu_offload_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Model CPU Offload", None))
        self.label_17.setText(QCoreApplication.translate("BasePurDi", u"This method works at the submodule level, not on whole models. This is the best way to minimize memory consumption, but inference is much slower due to the iterative nature of the process.", None))
        self.sequential_cpu_offload_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Sequential CPU Offload", None))
        self.cpu_offload_disable.setText(QCoreApplication.translate("BasePurDi", u"Disable", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.cpu_offload_item), QCoreApplication.translate("BasePurDi", u"CPU Offload", None))
        self.label_3.setText(QCoreApplication.translate("BasePurDi", u"NVIDIA cuDNN supports many algorithms to compute a convolution. Autotuner runs a short benchmark and selects the kernel with the best performance on a given hardware for a given input size.", None))
        self.cudnn_checkbox.setText(QCoreApplication.translate("BasePurDi", u"cuDNN", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.cudnn_item), QCoreApplication.translate("BasePurDi", u"cuDNN Auto-Tuner", None))
        self.label_4.setText(QCoreApplication.translate("BasePurDi", u"To save more GPU memory and get more speed, you can load and run the model weights directly in half precision. This involves loading the float16 version of the weights, which was saved to a branch named fp16, and telling PyTorch to use the float16 type when loading them:", None))
        self.half_precision_checkbox.setText(QCoreApplication.translate("BasePurDi", u"half-precision", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.half_precision_item), QCoreApplication.translate("BasePurDi", u"Half Precision", None))
        self.label_5.setText(QCoreApplication.translate("BasePurDi", u"Optimizes the bandwidth in the attention block for speed boost and memory efficiency. Requires PyTorch > 1.12, CUDA available, and xFormers", None))
        self.memory_efficient_attention_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Memory Efficient Attention", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.memory_efficient_item), QCoreApplication.translate("BasePurDi", u"Memory Efficient Attention - Xformer", None))
        self.label_6.setText(QCoreApplication.translate("BasePurDi", u"On Ampere and later CUDA devices matrix multiplications and convolutions can use the TensorFloat32 (TF32) mode for faster but slightly less accurate computations. By default PyTorch enables TF32 mode for convolutions but not matrix multiplications, and unless a network requires full float32 precision we recommend enabling this setting for matrix multiplications, too. It can significantly speed up computations with typically negligible loss of numerical accuracy.", None))
        self.tf32_item_checkbox.setText(QCoreApplication.translate("BasePurDi", u"tf32", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.tf32_item), QCoreApplication.translate("BasePurDi", u"TensorFloat32", None))
        self.label_7.setText(QCoreApplication.translate("BasePurDi", u"To decode large batches of images with limited VRAM, or to enable batches with 32 images or more, you can use sliced VAE decode that decodes the batch latents one image at a time.\n"
"\n"
"You likely want to couple this with enable_attention_slicing() or enable_xformers_memory_efficient_attention() to further minimize memory use.", None))
        self.sliced_vae_decode_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Sliced VAE", None))
        self.optimization_toolbox.setItemText(self.optimization_toolbox.indexOf(self.sliced_vae_item), QCoreApplication.translate("BasePurDi", u"Sliced VAE", None))
        self.image_upscaling_group.setTitle(QCoreApplication.translate("BasePurDi", u"Face Restoration", None))
        self.vqfr_pixmap.setText("")
        self.vqfr_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Enable", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.page_8), QCoreApplication.translate("BasePurDi", u"Vector_Quantized Face Restoration", None))
        ...
        self.latent_upscale_2x.setText(QCoreApplication.translate("BasePurDi", u"2x Latent", None))
...
#if QT_CONFIG(tooltip)
        self.right_dock_tab_widget.setTabToolTip(self.right_dock_tab_widget.indexOf(self.right_dock_inference), QCoreApplication.translate("BasePurDi", u"General parameters for inferencing and generating images", None))
#endif // QT_CONFIG(tooltip)
        self.sb_tab_sub_r_train.setTabText(self.sb_tab_sub_r_train.indexOf(self.train_dreambooth), QCoreApplication.translate("BasePurDi", u"Dream Booth", None))
        self.sb_tab_sub_r_train.setTabText(self.sb_tab_sub_r_train.indexOf(self.train_textual_inversion), QCoreApplication.translate("BasePurDi", u"Textual", None))
        self.sb_tab_sub_r_train.setTabText(self.sb_tab_sub_r_train.indexOf(self.train_lora), QCoreApplication.translate("BasePurDi", u"LORA", None))
        self.right_dock_tab_widget.setTabText(self.right_dock_tab_widget.indexOf(self.right_dock_train), QCoreApplication.translate("BasePurDi", u"Train", None))
        self.right_dock_tab_widget.setTabText(self.right_dock_tab_widget.indexOf(self.chat_mode), QCoreApplication.translate("BasePurDi", u"Chat", None))
        self.gb_general_layer.setTitle(QCoreApplication.translate("BasePurDi", u"Layers", None))
        self.label_20.setText(QCoreApplication.translate("BasePurDi", u"Change Theme", None))
        self.edit_theme_button.setText(QCoreApplication.translate("BasePurDi", u"Edit Theme", None))
        self.right_dock_tab_widget.setTabText(self.right_dock_tab_widget.indexOf(self.right_dock_general), QCoreApplication.translate("BasePurDi", u"General", None))
        self.prompt_positive_field.setPlainText("")
        self.prompt_positive_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"a shiba inu on the moon", None))
        self.prompt_field.setTabText(self.prompt_field.indexOf(self.prompt_positive_tab), QCoreApplication.translate("BasePurDi", u"+", None))
#if QT_CONFIG(tooltip)
        self.prompt_field.setTabToolTip(self.prompt_field.indexOf(self.prompt_positive_tab), QCoreApplication.translate("BasePurDi", u"positive prompts", None))
#endif // QT_CONFIG(tooltip)
        self.prompt_negative_field.setDocumentTitle("")
        self.prompt_negative_field.setPlainText("")
        self.prompt_negative_field.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"watermark, logo, disfigure... etc, etc", None))
        self.prompt_field.setTabText(self.prompt_field.indexOf(self.prompt_negative_tab), QCoreApplication.translate("BasePurDi", u"-", None))
#if QT_CONFIG(tooltip)
        self.prompt_field.setTabToolTip(self.prompt_field.indexOf(self.prompt_negative_tab), QCoreApplication.translate("BasePurDi", u"negative prompts", None))
#endif // QT_CONFIG(tooltip)
        self.generate_button.setText(QCoreApplication.translate("BasePurDi", u"Generate", None))
        self.toolbar_left.setWindowTitle(QCoreApplication.translate("BasePurDi", u"toolBar", None))
        self.left_dock_widget.setWindowTitle(QCoreApplication.translate("BasePurDi", u"Image Browser", None))
        self.image_browser_search.setText("")
        self.image_browser_search.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Search", None))
        self.image_browser_sort.setItemText(0, QCoreApplication.translate("BasePurDi", u"Newest", None))
        self.image_browser_sort.setItemText(1, QCoreApplication.translate("BasePurDi", u"Oldest", None))
        self.image_browser_sort.setItemText(2, QCoreApplication.translate("BasePurDi", u"A - Z", None))
        self.image_browser_sort.setItemText(3, QCoreApplication.translate("BasePurDi", u"Z - A", None))

        self.left_tab_widget.setTabText(self.left_tab_widget.indexOf(self.image_browser_widget), QCoreApplication.translate("BasePurDi", u"Images", None))
        self.bottom_prompts_search_bar_btn.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Search", None))
        self.bottom_prompts_sort.setItemText(0, QCoreApplication.translate("BasePurDi", u"A - Z", None))
        self.bottom_prompts_sort.setItemText(1, QCoreApplication.translate("BasePurDi", u"Z - A", None))

        ___qtablewidgetitem = self.bottom_dock_prompts_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("BasePurDi", u"Prompt", None));
        ___qtablewidgetitem1 = self.bottom_dock_prompts_table.verticalHeaderItem(0)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("BasePurDi", u"1", None));
        ___qtablewidgetitem2 = self.bottom_dock_prompts_table.verticalHeaderItem(1)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("BasePurDi", u"2", None));
        ___qtablewidgetitem3 = self.bottom_dock_prompts_table.verticalHeaderItem(2)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("BasePurDi", u"3", None));
        ___qtablewidgetitem4 = self.bottom_dock_prompts_table.verticalHeaderItem(3)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("BasePurDi", u"4", None));
        ___qtablewidgetitem5 = self.bottom_dock_prompts_table.verticalHeaderItem(4)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("BasePurDi", u"5", None));
        ___qtablewidgetitem6 = self.bottom_dock_prompts_table.verticalHeaderItem(5)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("BasePurDi", u"6", None));
        ___qtablewidgetitem7 = self.bottom_dock_prompts_table.verticalHeaderItem(6)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("BasePurDi", u"7", None));
        ___qtablewidgetitem8 = self.bottom_dock_prompts_table.verticalHeaderItem(7)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("BasePurDi", u"8", None));
        ___qtablewidgetitem9 = self.bottom_dock_prompts_table.verticalHeaderItem(8)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("BasePurDi", u"9", None));
        ___qtablewidgetitem10 = self.bottom_dock_prompts_table.verticalHeaderItem(9)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("BasePurDi", u"10", None));
        ...
        ___qtablewidgetitem11.setText(QCoreApplication.translate("BasePurDi", u"illustration of jupiter clouds by dan mumford, alien landscape and vegetation, epic scene, a lot of swirling clouds, high exposure, highly detailed, realistic, vibrant blue tinted colors, uhd", None));
        ___qtablewidgetitem12 = self.bottom_dock_prompts_table.item(1, 0)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("BasePurDi", u"illustration of jupiter clouds by dan mumford, alien landscape and vegetation, epic scene, a lot of swirling clouds, high exposure, highly detailed, realistic, vibrant blue tinted colors, uhd", None));
        ___qtablewidgetitem13 = self.bottom_dock_prompts_table.item(2, 0)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("BasePurDi", u"casa com arquitetura contempor\u00e2nea, com \u00e1rea de jardim, lago ornamental, dia ensolarado, imagem para capa de revista de arquitetura", None));
        ___qtablewidgetitem14 = self.bottom_dock_prompts_table.item(3, 0)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("BasePurDi", u"maximalist chaotic San Francisco, birds eye view, illustrated by Herg\u00e9, style of tin tin comics, pen and ink", None));
        ___qtablewidgetitem15 = self.bottom_dock_prompts_table.item(4, 0)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("BasePurDi", u"boy at cozy gaming control room in bedroom , massive , big screen, high tech , advanced , warzone, messy cluttered bedroom, cozy, nostalgic,", None));
        ___qtablewidgetitem16 = self.bottom_dock_prompts_table.item(5, 0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("BasePurDi", u"Vintage 60's cartoon style. cluttered bedroom interior; teenage youth inside a bedroom; by Hajime Sorayama, Greg Tocchini, Virgil Finlay, popart, colors, neon lights. line art.", None));
        ___qtablewidgetitem17 = self.bottom_dock_prompts_table.item(6, 0)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("BasePurDi", u"Architectural digest photo of a maximalist bathroom living room with lots of flowers and plants, golden light, award winning masterpiece with incredible details big windows, highly detailed, harper's bazaar art, fashion magazine, smooth, sharp focus, 8 k, octane render", None));
        ___qtablewidgetitem18 = self.bottom_dock_prompts_table.item(7, 0)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("BasePurDi", u"Cute and adorable cartoon rabbit baby, fantasy, dreamlike, surrealism, super cute, trending on artstation", None));
        self.bottom_dock_prompts_table.setSortingEnabled(__sortingEnabled)

#if QT_CONFIG(tooltip)
        self.bottom_dock_prompts_table.setToolTip(QCoreApplication.translate("BasePurDi", u"Shows saved prompts that can be re-used", None))
#endif // QT_CONFIG(tooltip)
        self.left_tab_widget.setTabText(self.left_tab_widget.indexOf(self.bottom_dock_prompts), QCoreApplication.translate("BasePurDi", u"Prompts", None))
        self.history_search_bar_btn.setPlaceholderText(QCoreApplication.translate("BasePurDi", u"Search", None))
        self.history_sort.setItemText(0, QCoreApplication.translate("BasePurDi", u"A - Z", None))
        self.history_sort.setItemText(1, QCoreApplication.translate("BasePurDi", u"Z - A", None))
        self.history_sort.setItemText(2, QCoreApplication.translate("BasePurDi", u"Scheduler", None))
        self.history_sort.setItemText(3, QCoreApplication.translate("BasePurDi", u"Model", None))

        ___qtablewidgetitem19 = self.img_history_table.horizontalHeaderItem(0)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("BasePurDi", u"prompt", None));
        ___qtablewidgetitem20 = self.img_history_table.horizontalHeaderItem(1)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("BasePurDi", u"negative", None));
        ___qtablewidgetitem21 = self.img_history_table.horizontalHeaderItem(2)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("BasePurDi", u"seed", None));
        ___qtablewidgetitem22 = self.img_history_table.horizontalHeaderItem(3)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("BasePurDi", u"scheduler", None));
        ___qtablewidgetitem23 = self.img_history_table.horizontalHeaderItem(4)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("BasePurDi", u"width", None));
        ___qtablewidgetitem24 = self.img_history_table.horizontalHeaderItem(5)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("BasePurDi", u"height", None));
        ___qtablewidgetitem25 = self.img_history_table.horizontalHeaderItem(6)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("BasePurDi", u"model", None));
        ___qtablewidgetitem26 = self.img_history_table.verticalHeaderItem(0)
        ___qtablewidgetitem26.setText(QCoreApplication.translate("BasePurDi", u"1", None));
        ___qtablewidgetitem27 = self.img_history_table.verticalHeaderItem(1)
        ___qtablewidgetitem27.setText(QCoreApplication.translate("BasePurDi", u"2", None));
        ___qtablewidgetitem28 = self.img_history_table.verticalHeaderItem(2)
        ___qtablewidgetitem28.setText(QCoreApplication.translate("BasePurDi", u"3", None));
        ___qtablewidgetitem29 = self.img_history_table.verticalHeaderItem(3)
        ___qtablewidgetitem29.setText(QCoreApplication.translate("BasePurDi", u"4", None));
        ___qtablewidgetitem30 = self.img_history_table.verticalHeaderItem(4)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("BasePurDi", u"5", None));
        ___qtablewidgetitem31 = self.img_history_table.verticalHeaderItem(5)
        ___qtablewidgetitem31.setText(QCoreApplication.translate("BasePurDi", u"6", None));
        ___qtablewidgetitem32 = self.img_history_table.verticalHeaderItem(6)
        ___qtablewidgetitem32.setText(QCoreApplication.translate("BasePurDi", u"7", None));
        ___qtablewidgetitem33 = self.img_history_table.verticalHeaderItem(7)
        ___qtablewidgetitem33.setText(QCoreApplication.translate("BasePurDi", u"8", None));
        ___qtablewidgetitem34 = self.img_history_table.verticalHeaderItem(8)
        ___qtablewidgetitem34.setText(QCoreApplication.translate("BasePurDi", u"9", None));
        ___qtablewidgetitem35 = self.img_history_table.verticalHeaderItem(9)
        ___qtablewidgetitem35.setText(QCoreApplication.translate("BasePurDi", u"10", None));
        self.left_tab_widget.setTabText(self.left_tab_widget.indexOf(self.history_widget), QCoreApplication.translate("BasePurDi", u"History", None))
    # retranslateUi
