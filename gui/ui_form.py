...
class Ui_BasePurDi(object):
    def setupUi(self, BasePurDi):
        ...
        self.image_variation_toolbox.setCurrentIndex(2)
    ...
    def retranslateUi(self, BasePurDi):
        ...
        self.save_controlnet_input_maps_checkbox.setText(QCoreApplication.translate("BasePurDi", u"Save Mask", None))
        ...
        self.cycle_diffusion_label.setText(QCoreApplication.translate("BasePurDi", u"A Text-Guided Image-to-Image Generation model proposed in Unifying Diffusion Models\u2019 Latent Space, with Applications to CycleDiffusion and Guidance by Chen Henry Wu, Fernando De la Torre. \n"
"\n"
"Notes: Only works with v1 SD checkpoints and best with square images.", None))
