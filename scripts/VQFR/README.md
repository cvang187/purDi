...
1. Install dependent packages
    ...
    # Following packages are required to run vqfr.py
...
python vqfr.py -i inputs/whole_imgs -o results -v 2.0 -s 2 -f 0.1

# for cropped face
python vqfr.py -i inputs/cropped_faces/ -o results -v 2.0 -s 1 -f 0.1 --aligned
```
