...
from scripts.VQFR.vqfr.archs.vqfrv1_arch import VQFRv1
from scripts.VQFR.vqfr.archs.vqfrv2_arch import VQFRv2
...
class VQFR_Demo:
    ...
    def __init__(
        self, model_path, upscale=2, arch="v1", bg_upsampler=None, device=None
    ):
        ...
        if arch == "v1":
            self.vqfr = VQFRv1(
                ...
                fix_keys=["embedding"],
                inpfeat_extraction_opt={"in_dim": 3, "out_dim": 32},
                align_from_patch=32,
                align_opt={
                    "Level_32": {
                        "cond_channels": 32,
            ...
            self.vqfr = VQFRv2(
                ...
                code_dim=256,
                inpfeat_dim=32,
                align_opt={"cond_channels": 32, "deformable_groups": 4},
    ...
    def enhance(
        ...
        for cropped_face in self.face_helper.cropped_faces:
            ...
            try:
                output = self.vqfr(cropped_face_t, fidelity_ratio=fidelity_ratio)[
                    "main_dec"
                ][0]
                # convert to image
