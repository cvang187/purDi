...
from scripts.VQFR.vqfr.models import lr_scheduler as lr_scheduler
from scripts.VQFR.vqfr.utils import get_root_logger
from scripts.VQFR.vqfr.utils.dist_util import master_only
...
class BaseModel:
    ...
    def setup_schedulers(self):
        ...
        if scheduler_type in ["MultiStepLR", "MultiStepRestartLR"]:
            ...
            for optimizer in self.optimizers:
                self.schedulers.append(
                    lr_scheduler.CosineAnnealingLR(optimizer, **train_opt["scheduler"])
                )
        else:
